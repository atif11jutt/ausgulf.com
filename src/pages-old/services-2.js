                ...
                <div className="row justify-content-center">
                    <div className="col-lg-4 col-sm-6">
                        <div className="single-ml-services-box">
                            <div className="image">
                                <img src={ServiceImage1} alt="something" />
                            </div>
                            <h3>
                    ...
                    <div className="col-lg-4 col-sm-6">
                        <div className="single-ml-services-box">
                            <div className="image">
                                <img src={ServiceImage2} alt="something" />
                            </div>
                            <h3>
                                <Link to="/service-details">
                                    Software Engineers
                    ...
                    <div className="col-lg-4 col-sm-6">
                        <div className="single-ml-services-box">
                            <div className="image">
                                <img src={ServiceImage3} alt="something" />
                            </div>
                            <h3>
                                <Link to="/service-details">
                    ...
                    <div className="col-lg-4 col-sm-6">
                        <div className="single-ml-services-box">
                            <div className="image">
                                <img src={ServiceImage4} alt="something" />
                            </div>
                            <h3>
                                <Link to="/service-details">
                    ...
                    <div className="col-lg-4 col-sm-6">
                        <div className="single-ml-services-box">
                            <div className="image">
                                <img src={ServiceImage5} alt="something" />
                            </div>
                            <h3>
                                <Link to="/service-details">
                    ...
                    <div className="col-lg-4 col-sm-6">
                        <div className="single-ml-services-box">
                            <div className="image">
                                <img src={ServiceImage6} alt="something" />
                            </div>
                            <h3>
                                <Link to="/service-details">
                                    Data Analysts
