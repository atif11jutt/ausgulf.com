                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="single-blog-post-box">
                                    <div className="entry-thumbnail">
                                        <Link to="/blog-details">
                                            <img src={BlogImg10} alt="something" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="single-blog-post-box">
                                    <div className="entry-thumbnail">
                                        <Link to="/blog-details">
                                            <img src={BlogImg11} alt="something" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="single-blog-post-box">
                                    <div className="entry-thumbnail">
                                        <Link to="/blog-details">
                                            <img src={BlogImg12} alt="something" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="single-blog-post-box">
                                    <div className="entry-thumbnail">
                                        <Link to="/blog-details">
                                            <img src={BlogImg13} alt="something" />
                                        </Link>
                                    </div>
                            ...
                            <div className="col-lg-6 col-md-6">
                                <div className="single-blog-post-box">
                                    <div className="entry-thumbnail">
                                        <Link to="/blog-details">
                                            <img src={BlogImg14} alt="something" />
                                        </Link>
                                    </div>
