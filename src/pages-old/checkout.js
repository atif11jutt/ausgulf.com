                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-12">
                            <div className="billing-details">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 col-md-6">
                                        <div className="form-group">
                                            <label htmlFor="exampleInputEmail1">Last Name <span className="required">*</span></label>
                                            <input type="text" className="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-12 col-md-6">
                                        <div className="form-group">
                                            <label htmlFor="exampleInputEmail1">Town / City <span className="required">*</span></label>
                                            <input type="text" className="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-6 col-md-6">
                                        <div className="form-group">
                                            <label htmlFor="exampleInputEmail1">State / County <span className="required">*</span></label>
                                            <input type="text" className="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-6 col-md-6">
                                        <div className="form-group">
                                            <label htmlFor="exampleInputEmail1">Postcode / Zip <span className="required">*</span></label>
                                            <input type="text" className="form-control" />
                                        </div>
                                    </div>
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="order-details">
                                ...
                                <Link to="#" className="btn btn-primary order-btn">Place Order</Link>
                            </div>
                        </div>
                    </div>
                </form>
