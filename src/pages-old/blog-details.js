                    ...
                    <div className="col-lg-8 col-md-12">
                        <div className="blog-details-desc">
                            <div className="article-image">
                                <img src={BlogDetailsImg} alt="something" />
                            </div>
                            ...
                            <div className="article-content">
                                ...
                                <ul className="block-gallery columns-3">
                                    <li className="blocks-gallery-item">
                                        <figure>
                                            <img src={BlogImg7} alt="something" />
                                        </figure>
                                    </li>

                                    <li className="blocks-gallery-item">
                                        <figure>
                                            <img src={BlogImg9} alt="something" />
                                        </figure>
                                    </li>

                                    <li className="blocks-gallery-item">
                                        <figure>
                                            <img src={BlogImg8} alt="something" />
                                        </figure>
                                    </li>
                                </ul>
                            ...
                            <div className="article-footer">
                                <div className="article-tags">
                                    <Link to="/blog-3">Fashion</Link>
                                    <Link to="/blog-3">Smart</Link>
                                    <Link to="/blog-3">Marketing</Link>
                                    <Link to="/blog-3">Games</Link>
                                    <Link to="/blog-3">Travel</Link>
                                </div>
                            </div>
                                    ...
                                    <div className="info-prev-link-wrapper">
                                        <Link to="#">
                                            <span className="image-prev">
                                                <img src={BlogImg2} alt="something" />
                                    ...
                                    <div className="info-next-link-wrapper">
                                        <Link to="#">
                                            ...
                                            <span className="image-next">
                                                <img src={BlogImg3} alt="something" />
                                ...
                                <ol className="comment-list">
                                        ...
                                        <article className="comment-body">
                                            <footer className="comment-meta">
                                                <div className="comment-author vcard">
                                                    <img src={ClientImg1} className="avatar" alt="something" />
                                        ...
                                        <ol className="children">
                                            <li className="comment">
                                                <article className="comment-body">
                                                    <footer className="comment-meta">
                                                        <div className="comment-author vcard">
                                                            <img src={ClientImg2} className="avatar" alt="something" />
                                            ...
                                            <ol className="children">
                                                <li className="comment">
                                                    <article className="comment-body">
                                                        <footer className="comment-meta">
                                                            <div className="comment-author vcard">
                                                                <img src={ClientImg3} className="avatar" alt="something" />
                                    ...
                                    <li className="comment">
                                        <article className="comment-body">
                                            <footer className="comment-meta">
                                                <div className="comment-author vcard">
                                                    <img src={ClientImg4} className="avatar" alt="something" />
                                        ...
                                        <ol className="children">
                                            <li className="comment">
                                                <article className="comment-body">
                                                    <footer className="comment-meta">
                                                        <div className="comment-author vcard">
                                                            <img src={ClientImg5} className="avatar" alt="something" />
