        ...
        <div className="widget-area" id="secondary">
            ...
            <div className="widget widget_tag_cloud">
                ...
                <div className="tagcloud">
                    <Link to="#">IT <span className="tag-link-count">(3)</span></Link>
                    <Link to="#">Spacle <span className="tag-link-count">(3)</span></Link>
                    <Link to="#">Games <span className="tag-link-count">(2)</span></Link>
