            ...
            <div className="container">
                ...
                <div className="row justify-content-md-center">
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="single-products">
                            <div className="products-image">
                                <img src={ShopImage1} alt="something" />
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="single-products">
                            <div className="products-image">
                                <img src={ShopImage2} alt="something" />
                            ...
                            <div className="products-content">
                                ...
                                <ul>
                                    ...
                                    <li><i className="flaticon-star-2"></i></li>
                                </ul>
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="single-products">
                            <div className="products-image">
                                <img src={ShopImage3} alt="something" />
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="single-products">
                            <div className="products-image">
                                <img src={ShopImage4} alt="something" />
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="single-products">
                            <div className="products-image">
                                <img src={ShopImage5} alt="something" />
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="single-products">
                            <div className="products-image">
                                <img src={ShopImage6} alt="something" />
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="single-products">
                            <div className="products-image">
                                <img src={ShopImage7} alt="something" />
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6">
                        <div className="single-products">
                            <div className="products-image">
                                <img src={ShopImage8} alt="something" />
