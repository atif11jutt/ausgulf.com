                ...
                > 
                    <div className="single-agency-portfolio-partner">
                        <a href="https://themeforest.net/user/envytheme/portfolio" target="_blank" rel="noreferrer">
                            <img src={APPartner1} alt="something" />
                        </a>
                    </div>
                    <div className="single-agency-portfolio-partner">
                        <a href="https://themeforest.net/user/envytheme/portfolio" target="_blank" rel="noreferrer">
                            <img src={APPartner2} alt="something" />
                        </a>
                    </div>
                    <div className="single-agency-portfolio-partner">
                        <a href="https://themeforest.net/user/envytheme/portfolio" target="_blank" rel="noreferrer">
                            <img src={APPartner3} alt="something" />
                        </a>
                    </div>
                    <div className="single-agency-portfolio-partner">
                        <a href="https://themeforest.net/user/envytheme/portfolio" target="_blank" rel="noreferrer">
                            <img src={APPartner4} alt="something" />
                        </a>
                    </div>
                    <div className="single-agency-portfolio-partner">
                        <a href="https://themeforest.net/user/envytheme/portfolio" target="_blank" rel="noreferrer">
                            <img src={APPartner5} alt="something" />
                        </a>
                    </div>
                    <div className="single-agency-portfolio-partner">
                        <a href="https://themeforest.net/user/envytheme/portfolio" target="_blank" rel="noreferrer">
                            <img src={APPartner6} alt="something" />
                        </a>
                    </div>
                </OwlCarousel> : ''} */}
            </div>
