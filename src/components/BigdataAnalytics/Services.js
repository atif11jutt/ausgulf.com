                ...
                <div className="row justify-content-center">
                    <div className="col-lg-4 col-md-6 col-sm-12">
                        <div className="single-services-box-item">
                            ...
                            <div className="shape">
                                <img src={Rectangle} alt="something" />
                            </div>
                        </div>
                    </div>
